...
NS_LOG_COMPONENT_DEFINE ("TcpBulkSendExampleeqwe");


std::vector<double>
Eval_Triple (int runNum)
{
...
//
  ...
  pointToPoint.SetChannelAttribute ("Delay", TimeValue (MilliSeconds(50)));
...
//
  ...
  NS_LOG_INFO ("Done.");
  double mptcp = (sink1->GetTotalRx ()*8)/(1000000*(time-2));
