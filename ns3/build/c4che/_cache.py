...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Wextra', '-std=c++11', '-march=native', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
...
NS3_EXECUTABLE_PATH = ['/media/psf/iCloud/Uni/Masterthesis/ss20-ma-kaywallasshek-ml-mptcp/ns3-mptcp/build/src/emu', '/media/psf/iCloud/Uni/Masterthesis/ss20-ma-kaywallasshek-ml-mptcp/ns3-mptcp/build/src/fd-net-device', '/media/psf/iCloud/Uni/Masterthesis/ss20-ma-kaywallasshek-ml-mptcp/ns3-mptcp/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/media/psf/iCloud/Uni/Masterthesis/ss20-ma-kaywallasshek-ml-mptcp/ns3-mptcp/build']
...
cfg_files = ['/media/psf/iCloud/Uni/Masterthesis/ss20-ma-kaywallasshek-ml-mptcp/ns3-mptcp/build/ns3/config-store-config.h', '/media/psf/iCloud/Uni/Masterthesis/ss20-ma-kaywallasshek-ml-mptcp/ns3-mptcp/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
