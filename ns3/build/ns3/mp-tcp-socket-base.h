...
public: // public variables
  ...
  // RTT_map
  std::map<uint8_t, int64_t> rttMap;
  int maxPktsUnprobed = 10;
  void SetMaxPktsUnprobed(int num);
  // Neat related functions
  void SetNeatNN(NEAT::Network* ntw, NEAT::Network* meta_ntw);
  NEAT::Network* ntw; // Neat Neural Network
  NEAT::Network* meta_ntw; // Neat Neural Network for Meta-Scheduler
  uint8_t metaScheduler();
  // Crossflow
  void DisableMpTcp(); 
  bool mpTcp_enabled = true;
